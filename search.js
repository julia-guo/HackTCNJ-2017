document.getElementById('submit').addEventListener('click', function() {
    ...
    const newYorkEvents = 'Upcoming events near you are <div class="location">Go Green Day!</div> at the <div class="location">Stony Brook-Millstone Watershed</div> on <div class="location">March 17</div></div>.';
